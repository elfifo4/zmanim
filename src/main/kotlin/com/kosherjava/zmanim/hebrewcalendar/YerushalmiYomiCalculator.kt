...
object YerushalmiYomiCalculator {
    ...
    private const val DAY_MILIS = 1000 * 60 * 60 * 24

    /** The number of pages in the Talmud Yerushalmi. */
    private const val WHOLE_SHAS_DAFS = 1554

    /** The number of pages per *masechta* (tractate). */
    private val BLATT_PER_MASECHTA = intArrayOf(
    ...
    fun getDafYomiYerushalmi(calendar: JewishCalendar): Daf? {
        ...
        val requested = calendar.gregorianCalendar
        var masechta = 0
        ...
        require(!requested.before(DAF_YOMI_START_DAY)) {
