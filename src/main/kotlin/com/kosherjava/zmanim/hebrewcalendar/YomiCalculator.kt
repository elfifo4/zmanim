...
object YomiCalculator {
    ...
    private val dafYomiJulianStartDay = getJulianDay(dafYomiStartDay)
     ...
     * @see .getDafYomiBavli
     */
    private val shekalimJulianChangeDay = getJulianDay(shekalimChangeDay)
    ...
    fun getDafYomiBavli(jewishCalendar: JewishCalendar): Daf? {
		 ...
		 */
        val blattPerMasechta = intArrayOf(
        ...
        val calendar = jewishCalendar.gregorianCalendar
