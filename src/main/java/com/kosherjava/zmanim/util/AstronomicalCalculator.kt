...
abstract class AstronomicalCalculator : Cloneable {
     ...
     */
    abstract fun getCalculatorName(): String?
    /**
     ...
     */
    abstract fun getUTCSunrise(calendar: Calendar, geoLocation: GeoLocation, zenith: Double, adjustForElevation: Boolean): Double
     ...
     * @see .getElevationAdjustment
     */
    abstract fun getUTCSunset(calendar: Calendar, geoLocation: GeoLocation, zenith: Double, adjustForElevation: Boolean): Double
    ...
    companion object {
         ...
         */
        private const val GEOMETRIC_ZENITH = 90.0
         ...
         */
		@JvmStatic val default: AstronomicalCalculator
            get() = NOAACalculator()
    }
}
