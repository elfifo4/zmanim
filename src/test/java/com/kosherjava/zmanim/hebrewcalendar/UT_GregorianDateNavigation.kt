...
class UT_GregorianDateNavigation {
    ...
    fun gregorianForwardMonthToMonth() {
        ...
        Assert.assertEquals(5771, hebrewDate.jewishYear.toLong())
        ...
        Assert.assertEquals(1, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(11, hebrewDate.jewishMonth.toLong())
        ...
        Assert.assertEquals(1, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(28, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(12, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(24, hebrewDate.jewishDayOfMonth.toLong())
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(2, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(12, hebrewDate.jewishMonth.toLong())
        ...
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(3, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(13, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(26, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.APRIL
        cal[Calendar.DATE] = 30
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(4, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(1, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(27, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.MAY
        cal[Calendar.DATE] = 31
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(5, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(2, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(28, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.JUNE
        cal[Calendar.DATE] = 30
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(6, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(3, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(29, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.JULY
        cal[Calendar.DATE] = 31
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(7, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(5, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(1, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.AUGUST
        cal[Calendar.DATE] = 31
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(8, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(6, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(2, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.SEPTEMBER
        cal[Calendar.DATE] = 30
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(9, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(7, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(3, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.OCTOBER
        cal[Calendar.DATE] = 31
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(10, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(5772, hebrewDate.jewishYear.toLong())
        Assert.assertEquals(8, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(4, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.NOVEMBER
        cal[Calendar.DATE] = 30
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(11, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(9, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(5, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.MONTH] = Calendar.DECEMBER
        cal[Calendar.DATE] = 31
        hebrewDate.setDate(cal)
        hebrewDate.forward(Calendar.DATE, 1)
        Assert.assertEquals(2012, hebrewDate.gregorianYear.toLong())
        Assert.assertEquals(0, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(1, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(10, hebrewDate.jewishMonth.toLong())
    ...
    fun gregorianBackwardMonthToMonth() {
        ...
        val hebrewDate = JewishDate(cal)
        hebrewDate.back()
        Assert.assertEquals(2010, hebrewDate.gregorianYear.toLong())
        Assert.assertEquals(11, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(31, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(10, hebrewDate.jewishMonth.toLong())
        Assert.assertEquals(24, hebrewDate.jewishDayOfMonth.toLong())
        cal[Calendar.DATE] = 1
        cal[Calendar.MONTH] = Calendar.DECEMBER
        ...
        hebrewDate.back()
        Assert.assertEquals(10, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(30, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(9, hebrewDate.jewishMonth.toLong())
        ...
        Assert.assertEquals(7, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(31, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(5770, hebrewDate.jewishYear.toLong())
        Assert.assertEquals(6, hebrewDate.jewishMonth.toLong())
        ...
        Assert.assertEquals(5, hebrewDate.gregorianMonth.toLong())
        Assert.assertEquals(30, hebrewDate.gregorianDayOfMonth.toLong())
        Assert.assertEquals(4, hebrewDate.jewishMonth.toLong())
